...
<div class="container mx-auto px-4 py-8 max-w-2xl">
	...
	>
		...
		<div>
			<label for="contributionsListName" class="block text-sm font-medium text-gray-700 mb-1">
				Name der Beitragsliste
			</label>
			<input
				type="text"
				id="contributionsListName"
				name="contributionsListName"
				value={data.event.contributionsListName || ''}
				placeholder="Beiträge"
				class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
			/>
			<p class="text-xs text-gray-500 mt-1">
				Leer lassen für Standardnamen "Beiträge"
			</p>
		</div>
